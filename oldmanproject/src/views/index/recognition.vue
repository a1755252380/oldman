<template>
    <el-row :gutter="10" style="height:100%l;">
        <el-col :span="4" style="overflow:auto">
            <div style="height:318px">
                <div v-for="(item, index) in 6" :key="index" :class="{recognition_choose_active:clickindex===index,recognition_choose:true}" @click="changerecognition(index)">场景{{item}}</div>
            </div>
        </el-col>
         <el-col :span="20" style="overflow:auto" >
        <waterfall style="height:318px" :col="col" :width="180" :gutterWidth="gutterWidth"  :data="data"  @loadmore="loadmore"  @scroll="scroll"   >
      <template >
        <div class="cell-item" v-for="(item,index) in data " :key="index">
           <div :style="{'background':'url('+item.img+') repeat 100% 100%',backgroundSize: '100%'}" class="item-img"></div>
          <div class="item-body">
